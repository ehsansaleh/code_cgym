...
#define nlr_buflen (done_inner_steps + 1 - observation_delay_steps)
...
#if ENVNAME == NLRPendulum
  // gamma, self.max_ep_len = 0.99, 200
  // r_coeff = 20. * (1. - gamma ** self.max_ep_len) /
  //           ((1.-gamma) * (gamma**self.max_ep_len))
